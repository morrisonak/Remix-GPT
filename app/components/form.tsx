  ...
  <Form.Root className="w-[260px]">
    <Form.Field className="grid mb-[10px]" name="email">
      <div className="flex items-baseline justify-between">
        ...
        <Form.Message className="text-[13px] text-black" match="typeMismatch">
    ...
    <Form.Submit asChild>
      <button className="box-border w-full text-violet11 shadow-blackA7 hover:bg-sky-600 inline-flex h-[35px] items-center justify-center rounded-[4px] bg-sky-900 px-[15px] font-medium leading-none shadow-[0_2px_10px] focus:shadow-[0_0_0_2px] focus:shadow-black focus:outline-none mt-[10px]">
        Post question
      </button>
    </Form.Submit>
  </Form.Root>
